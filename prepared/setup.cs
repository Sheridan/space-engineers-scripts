...
case 65: (new CB <IMyProjector> ()).s("Проектор"); break;
case 66: (new CB <IMyMotorAdvancedStator>()).s("Ул. Ротор"); break;
case 67: (new CB <IMyMotorStator> ()).s("Ротор"); break;
case 68: (new CB <IMyControlPanel> ()).s("Панель упр."); break;
default: {
Runtime.UpdateFrequency = UpdateFrequency.None;
