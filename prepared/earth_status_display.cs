...
lcd = new CBSD();
lcd.aD("[Земля] Дисплей Статус 4", 0, 0);
lcd.aD("[Земля] Дисплей Статус 1", 1, 0);
lcd.aD("[Земля] Дисплей Статус 0", 2, 0);
lcd.aD("[Земля] Дисплей Статус 5", 0, 1);
lcd.aD("[Земля] Дисплей Статус 2", 1, 1);
lcd.aD("[Земля] Дисплей Статус 3", 2, 1);
debug("Done displays");
initGroups();
...
lcd.sS<IMyPowerProducer>(windTurbines, i++);
lcd.sS<IMySolarPanel>(solarPanels, i++);
lcd.sS<IMyBatteryBlock>(battaryes, i++);
lcd.sS<IMyPowerProducer>(h2Engines, i++);
lcd.sS<IMyShipConnector>(connectors, i++);
lcd.sS<IMyRefinery>(refineryes, i++);
lcd.sS<IMyAssembler>(assemblers, i++);
lcd.sS<IMyGasGenerator>(gasGenerators, i++);
lcd.sS<IMyCargoContainer>(storageOre, i++);
